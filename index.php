	...
	<body>
		<div class="container">
			...
			<section id="information">
				...
				<div class="social">
					<ul class="nav">
						...
						<li class="social-icon"><a class="social-3" href="<?php echo $socialdetails['youtube']; ?>"><span class="icon">7</span></a></li>
			...
			<section id="profile">
				...
				<a href="resume.pdf" download>	<button class="download">DOWNLOAD</button></a>
			...
			<footer id="footer">
				<a href="#" id="toTop"></a>
				COPYRIGHT &copy; 2020 - MAYANK SINGH KUSHWAH. ALL RIGHTS RESERVED.
			</footer>
		</div>
		<?php
