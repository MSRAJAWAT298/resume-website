<?php
	...
	if(isset($_POST['social'])) {
		...
		$query="update social set facebook='$facebook', twitter='$twitter', youtube='$youtube', instagram='$instagram' where uid=1";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
	}
?>
			<div class="row">
				...
				<form method="post">
					...
					<div class="form-group">
					  <div class="input-group">
						...
						<input type="text" class="form-control" name="youtube" value="<?php echo $socialdetails['youtube']; ?>">
					  </div>
					</div>
					<div class="form-group">
					  <div class="input-group">
